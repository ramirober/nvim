return {
  ...
  config = function()
    require("neo-tree").setup({
      ...
      open_files_do_not_replace_types = { "terminal", "Trouble", "qf", "edgy", "NeoTree" }, -- when opening files, do not use windows containing these filetypes or buftypes
    ...
    vim.keymap.set("n", "<leader>e", ":Neotree action=focus toggle reveal<CR>")
  end,
}
